...
import { Camera, ChevronDown, ChevronRight, Zap, Target, BarChart3, LogOut } from "lucide-react"
...
export default function CalisthenicsAnalyzer({ user, onSignOut }: { user: User, onSignOut: () => Promise<void> }) {
                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="text-right">
                                <p className="text-xs font-medium text-[#6B5B73]">{user.email}</p>
                            </div>
