...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F5F1ED] font-poppins">
            {/* Navigation */}
            <nav className="bg-white border-b border-[#E5DDD5] sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            <Link href="#features" className="text-[#6B5B73] hover:text-[#3A3A3A] transition-colors duration-200">
                                Features
                            </Link>
                            <Link href="#how-it-works" className="text-[#6B5B73] hover:text-[#3A3A3A] transition-colors duration-200">
                                How it Works
                            </Link>
                            <Link href="#testimonials" className="text-[#6B5B73] hover:text-[#3A3A3A] transition-colors duration-200">
                                Testimonials
                            </Link>
                            <Link href="#pricing" className="text-[#6B5B73] hover:text-[#3A3A3A] transition-colors duration-200">
                                Pricing
                            </Link>
                        </div>
                        <div className="flex items-center space-x-4">
                            ...
                            <Button
                                asChild
                                className="bg-[#D4A574] hover:bg-[#C19660] text-white border-0 font-semibold px-6 py-2 rounded-lg transition-all duration-200"
                            >
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            <div className="space-y-4">
                                <div className="inline-flex items-center space-x-2 bg-[#FAF8F5] px-4 py-2 rounded-full">
                                ...
                                <h1 className="text-4xl lg:text-6xl font-bold text-[#3A3A3A] leading-tight">
                                    Perfect Your <span className="text-[#D4A574]">Calisthenics</span> Form with AI
                                </h1>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Button
                                    asChild
                                    size="lg"
                                    className="bg-[#D4A574] hover:bg-[#C19660] text-white border-0 font-semibold px-8 py-4 rounded-lg transition-all duration-200"
                                >
                                ...
                                <Button
                                    variant="outline"
                                    size="lg"
                                    className="border-[#E5DDD5] text-[#3A3A3A] bg-white hover:bg-[#FAF8F5] hover:border-[#D4A574] font-semibold px-8 py-4 rounded-lg transition-all duration-200"
                        ...
                        <div className="relative">
                            <div className="bg-white rounded-2xl shadow-xl p-8 border border-[#E5DDD5]">
                                <div className="aspect-video bg-[#FAF8F5] rounded-xl flex items-center justify-center mb-6">
                                    <div className="text-center space-y-4">
                                        <div className="w-16 h-16 bg-[#D4A574] rounded-full flex items-center justify-center mx-auto">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {features.map((feature, index) => (
                            <Card
                                key={index}
                                className="border-[#E5DDD5] shadow-sm bg-white rounded-xl hover:shadow-md transition-shadow duration-200"
                            >
                                <CardContent className="p-6 text-center">
                                    <div className="w-12 h-12 bg-[#FAF8F5] rounded-lg flex items-center justify-center mx-auto mb-4 text-[#D4A574]">
                                        {feature.icon}
                                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={index} className="text-center">
                                <div className="w-16 h-16 bg-[#D4A574] rounded-full flex items-center justify-center mx-auto mb-6 text-white text-xl font-bold">
                                    {step.step}
                                </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="space-y-6">
                                {benefits.map((benefit, index) => (
                                    <div key={index} className="flex items-start space-x-4">
                                        <div className="w-10 h-10 bg-[#FAF8F5] rounded-lg flex items-center justify-center text-[#D4A574] flex-shrink-0">
                                            {benefit.icon}
                                        </div>
                                        <div>
                        ...
                        <div className="bg-[#FAF8F5] rounded-2xl p-8">
                            <div className="aspect-square bg-white rounded-xl flex items-center justify-center">
                                <div className="text-center space-y-4">
                                    <div className="w-20 h-20 bg-[#D4A574] rounded-full flex items-center justify-center mx-auto">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {testimonials.map((testimonial, index) => (
                            <Card key={index} className="border-[#E5DDD5] shadow-sm bg-white rounded-xl">
            ...
            {/* CTA Section */}
            <section className="py-20 bg-[#D4A574]">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Ready to Perfect Your Form?</h2>
                    ...
                    <Button
                        asChild
                        size="lg"
                        className="bg-white hover:bg-gray-50 text-[#D4A574] border-0 font-semibold px-8 py-4 rounded-lg transition-all duration-200"
                    >
                        <Link href="/auth" className="flex items-center">
                    ...
                    <p className="text-white/80 text-sm mt-4">No credit card required • 7-day free trial</p>
                </div>
            </section>
